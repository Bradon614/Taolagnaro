...
const FIELDS = [
  { label: "Quoi", placeholder: "Plage, lodge, randonnée…", grow: "sm:flex-[1.4]" },
  { label: "Où", placeholder: "Partout dans l’Anosy", grow: "sm:flex-1" },
  { label: "Quand", placeholder: "Dates souples", grow: "sm:flex-[0.85]" },
];
